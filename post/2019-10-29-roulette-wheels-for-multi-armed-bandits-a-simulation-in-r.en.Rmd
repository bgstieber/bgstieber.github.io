...
And our draw from the random uniform was 0.7, we'd pick the third arm (0.7 falls between 0.5 and 1). This selection criteria is the main point of Dr. McCaffrey's algorithm.
